...
parser.add_argument('--model_path', type=str, default='log5/epoch_100.ckpt', help='Path of model')
parser.add_argument('--log_dir', default='log5', help='Log dir [default: logs]')
